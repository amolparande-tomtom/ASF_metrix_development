...
ST_DWithin_mnr_osm_intersect_sql = """
            select
            code as country,
            ...
            and ST_DWithin("{schema_name}".mnr_apt.geom, ST_GeomFromText('{point_geometry}',4326), 0.0003)

"""

# 0.0003 = 30 Meter

# and ST_DWithin(_2022_06_003_oce_aus_aus.mnr_apt.geom, ST_GeomFromText('{}',4326), 0.0003)
# schema_data = pd.read_sql_query(mnr_osm_intersect_sql, db_connection_MNR)

ST_DWithin_VAD_intersect_sql = """
                                select 
                                osm_id,
                                ...
                                ST_GeomFromText('{point_geometry}',4326), 0.0003)
                                """
