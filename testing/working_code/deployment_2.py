...
# Input CSV
inputcsv = r'F:\\Amol\\10_Python\\2_ASF_Python\\2_ADOC\\ESP_log.csv'
outputpath = r'F:\\Amol\\10_Python\\2_ASF_Python\\2_ADOC\\'
mnrfilename = 'MNR_ASF_output_BEL_NL.csv'
vad_filename = 'VAD_ASF_output_ESP.csv'
...
VAD_schema_name = 'eur_esp_20220702_cw26'
